...
class PlacedOrdersHeader extends StatefulWidget {
  ...
  const PlacedOrdersHeader(
      ...
      : super(key: key);
  @override
  _PlacedOrdersHeaderState createState() => _PlacedOrdersHeaderState();
}

class _PlacedOrdersHeaderState extends State<PlacedOrdersHeader> {
