...
class ReceivedOrdersHeader extends StatefulWidget {
  ...
  const ReceivedOrdersHeader(
      ...
      : super(key: key);
  @override
  _ReceivedOrdersHeaderState createState() => _ReceivedOrdersHeaderState();
}

class _ReceivedOrdersHeaderState extends State<ReceivedOrdersHeader> {
