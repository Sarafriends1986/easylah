...
class StateMyProfile extends StatefulWidget {
  String loginUser;
  List userItemList;

  StateMyProfile({this.loginUser, this.userItemList});
  ...
  @override
  _StateMyProfileState createState() => _StateMyProfileState();
}

class _StateMyProfileState extends State<StateMyProfile> {
//  String loginUser = '';
//  @override
//  void intState() {
...
//  }
  ...
  String myhint = 'Search My Listings!!!';

  bool isSearching = false;

  //List allUserDBProductList = MyDataOperations().listUserItemForEach(dbProductList,loginUser);
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            InkWell(
                ...
                child: _buildStatItem("Ratings", '4.5')),
          ],
        ),
      ),
    );
...
//                            print(widget.loginUser);
                            ...
                            List allUserDBProductList = await MyDataOperations()
                                .listUserItemForEach(
                                    allDBProductList, widget.loginUser);
//                            print(allUserDBProductList.toString());
//                            print('===============================');
//                            print(val);
...
//                          ),
            ...
            SliverList(
              delegate: SliverChildListDelegate([
                Divider(),
                // No need to show other user Related Items
//                Padding(
...
//                ),
            ...
            // No need to Show other user item in your Profile
//            SliverGrid(
//                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
//                  ///no.of items in the horizontal axis
//                  crossAxisCount: 2,
...
//                    /// if (index > n) return null;
//                    return SingleProduct(
//                        uid_name: relatedProductList[index]['uid_name'],
//                        prod_name: relatedProductList[index]['prod_name'],
//                        prod_desc: relatedProductList[index]['prod_desc'],
//                        uid_location: relatedProductList[index]['uid_location'],
//                        prod_price: relatedProductList[index]['prod_price'],
//                        prod_picture: relatedProductList[index]['prod_picture']);
//                  },
//
//                  /// Set childCount to limit no.of items // always defined bottom
//                  //childCount: 100,
//                  childCount: relatedProductList.length,
//                )),
          ],
        ),
      ),
