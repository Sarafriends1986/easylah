...
class ChatHistoryHeader extends StatefulWidget {
  ...
  const ChatHistoryHeader(
      ...
      : super(key: key);
  @override
  _ChatHistoryHeaderState createState() => _ChatHistoryHeaderState();
}

class _ChatHistoryHeaderState extends State<ChatHistoryHeader> {
